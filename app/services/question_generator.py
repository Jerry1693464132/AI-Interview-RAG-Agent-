...
class QuestionGenerator:
    ...
    def _generation_system_prompt(self) -> str:
        return (
            ...
            "## 题型说明\n"
            "- knowledge: 知识深度 — 考察原理、机制、底层实现（口头讲述）\n"
            "- practice: 工程实践 — 考察设计、排查、架构决策（口头讲述）\n"
            "- soft_skill: 软技能 — 考察沟通、协作、学习\n\n"
            "## 重要约束：所有题目必须是口头回答型\n"
            "这是一场口头面试，候选人无法写代码。题目必须能用语言描述回答，\n"
            "严禁出现以下内容：\n"
            "- 要求写代码、编写函数、实现算法\n"
            "- 要求写出Python/Java/JS等任何语言的代码\n"
            "- 包含代码块或代码示例\n"
            "- \"请写一个...\"\"请编写...\"\"请实现一个...函数\"等措辞\n\n"
            "practice 类型的题目应该考察系统设计、故障排查、方案选型、架构决策等\n"
            "可以用口头描述回答的问题，而非写代码。\n\n"
            "## 要求\n"
